            ...
            <Nav className="sidebar">
                <Nav.Item>
                    <ListGroup className='list-group' variant="flush" defaultActiveKey={filterid ? `#filter-${filterid}` : '#filter-all'}>
                        <NavLink to={`/`} onClick={() => props.setBack("/")} className={"active"}> 
                        ...
                        <NavLink to={`/filter/favorites`} onClick={() => props.setBack("/filter/favorites")}>
                        ...
                        <NavLink to={`/filter/best-rated`} onClick={() => props.setBack("/filter/best-rated")}>
                        ...
                        <NavLink to={`/filter/seen-last-month`} onClick={() => props.setBack("/filter/seen-last-month")}>
                        ...
                        <NavLink to={`/filter/unseen`} onClick={() => props.setBack("/filter/unseen")}>
